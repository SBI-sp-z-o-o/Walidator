...
{
    public class ModelDebugDistance : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            textMeshGo = new GameObject(gameObject.GetInstanceID() + "_text");
        ...
        void Update()
        {
            ...
            textMesh.text = transform.name + " " + Vector3.Distance(startPos, endPos).ToString("0.00", CultureInfo.InvariantCulture) + "m";
        }
    }
